 ...
 * @version 1, 11/23/12
 */
public abstract class AbstractService<Req, Rep> extends Thread implements Closeable {
    private ZMQ.Context context;
    private ZMQ.Socket sender;
    private boolean running = true;

    public AbstractService(String port) {
    ...
    protected abstract Req convertData(byte[] data);

    protected abstract byte[] convertData(Rep data);

    protected abstract Rep handleRequest(Req data);
