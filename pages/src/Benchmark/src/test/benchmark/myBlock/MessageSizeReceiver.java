 ...
 * @version 1, 2/12/13
 */
public class MessageSizeReceiver extends SinkComponent {
    long timestamp;
    double avg;
    int size;
    boolean started;
    ...
    public MessageSizeReceiver(String outboundPort, ComponentConfig config) {
    ...
    protected void handleData(GenericData data) {
        String stringData = ((StringData) data).getData();
