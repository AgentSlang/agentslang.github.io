...
/**
 * This class component provides general message passing and socket functionalities in order to receive string data using a ZeroMQ socket.
...
public class ZmqRecvStringComponent extends LivingComponent
{
    // Attributes
    ...
    private ZmqRecvString zmqRecvString;
    private long messageID = 0;

    // Constructors - Destructors
    public ZmqRecvStringComponent(String outboundPort, ComponentConfig config)
    {
    ...
    */
    protected void setupComponent(ComponentConfig config)
    {
        ...
        // Init ZmqRecvString
        zmqRecvString = new ZmqRecvString(inPort, inTopicName);
    }
    ...
    public boolean act()
    {
        ...
        String messageReceived = zmqRecvString.recvMessage();
